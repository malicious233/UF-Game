...
if (menu_control)
{
	...
	{
		menu_x_target = gui_width-832//+200; //coupled with gui_margin in Create? -32 makes it so the menu doesnt move
...
if (menu_x > gui_width-833) && (menu_committed != -1)    //-33 (one behind -32) makes it so something actually happens when pressing enter
{
